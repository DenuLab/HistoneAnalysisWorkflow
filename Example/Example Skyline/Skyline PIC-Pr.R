...
data <- read.csv("Skyline_PICPr_Histone_Report.csv")
...
groups <- normalized %>% 
  mutate(Sample_Type = ifelse(grepl("_02|_06|12", Sample), "HCT116",
                       ifelse(grepl("04|14|08", Sample), "HEK293", 
                       ifelse(grepl("11|07|_18", Sample), "HepG2", 
                       ifelse(grepl("17|09|_01", Sample), "PANC1",
                       ifelse(grepl("13|16|03", Sample), "MCF7", "set17"))))))
